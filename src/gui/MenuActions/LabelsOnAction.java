 ...
 * @author zabetak
 */
public class LabelsOnAction extends AbstractAction implements MenuActionInterface{
    ...
    /**
         * The Menu that is responsible for turning on the labels of the edges
         */
        private void labelsOnMenu(){
            getActiveGraph().setEdgeLabelsVisibility(true);
