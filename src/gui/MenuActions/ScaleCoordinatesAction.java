 ...
 * @author zabetak
 */
public class ScaleCoordinatesAction extends AbstractAction implements MenuActionInterface {

    public void actionPerformed(ActionEvent arg0) {
        scaleOnlyCoordinates();
    }
    ...
    private void scaleOnlyCoordinates() {
        ...
        zoom.setValue(getActiveGraph().getScaleCoordinateFactor());
        ...
        int result = JOptionPane.showOptionDialog(
                ...
                "Scale Coordinates", // the title of the dialog window 
        ...
        if (result == 0) {
            ...
            int scaleC = zoom.getValue();
            getActiveGraph().scaleCoordinates(scaleC);
        }//end if result == 0

    }//end scaleOnlyCoordinates
